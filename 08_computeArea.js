...
var root = 'projects/ee-deisejunqueira/assets/AUGI-MAP/classification/';

// define files to process 
var asset = [
  //root + 'depressaoPeriferica_classification_v2',
  root + 'depressaoPeriferica_classification_SENTINEL_v2',
  root + 'depressaoPeriferica_classification_EMBEDDINGS_v2',
  root + 'depressaoPeriferica_classification_EMBEDDINGS_v2_temporal_v2',
  root + 'depressaoPeriferica_classification_EMBEDDINGS_v2_temporal_v2_spatial_v2'
];

// define classification regions
// read study area
var carta = ee.FeatureCollection('projects/ee-deisejunqueira/assets/DepressaoPeriferica');
var territory = ee.Image().paint(carta, 'id').rename('territory');
